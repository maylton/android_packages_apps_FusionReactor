...
package com.fusion.reactor.settings.gestureanywhere;
...
public class GestureAnywhereSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mTriggerWidthPref.setValue(triggerWidth);
        ...
        mTriggerTopPref.setValue(triggerTop);
        ...
        mTriggerBottomPref.setValue(triggerBottom);
